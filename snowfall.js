/***************************************************************************
   ...
   Adds pretty snowfall effect to your web page
   
   Make sure that this script is declared in your page BEFORE your 
   main script file is declared.
   ...
   Usage Example:
      ...
      And snow will continously fall! (96,000 flakes in all!)
...
function Snowfall(params) {
  ...
  function drawSnowFlakesForLayer(nCanvas, cntrNd, siFlakeColor) {
    try {
      ...
      s.push("        opacity:1;")
      s.push("      }")
      s.push(" to {transform: translate("+(xOffset*2)+"px, "+screen.height+"px);}")
      s.push("}")
      s.push("")
...
function canvasAAnimationCompleted(evt) {
  try {
    ...
    snowflakeLayer.currentAniPartA = handleAnimationSwitch(canvasA, canvasB, snowflakeLayer.currentAniPartA, snowflakeLayer.aniPart1, snowflakeLayer.aniPart2, "A")
  ...
  function canvasBAnimationCompleted(evt) {
    try {
      ...
      snowflakeLayer.currentAniPartB = handleAnimationSwitch(canvasB, canvasA, snowflakeLayer.currentAniPartB, snowflakeLayer.aniPart1, snowflakeLayer.aniPart2, "B")
  ...
  function handleAnimationSwitch(eventCanvas, otherCanvas, currentAniPart, sAniPart1, sAniPart2, sAB) {
    try {
      if (currentAniPart === 1) {
        /*
